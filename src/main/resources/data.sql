...
--
--
INSERT INTO movie(movie_title, movie_genre, movie_release_date, movie_director, movie_poster_url, movie_trailer)
...
INSERT INTO character(character_name, character_alias, character_gender, character_picture_url)
